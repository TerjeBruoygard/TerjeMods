modded class TerjeSettingsCollection
{
	...
	override void OnInit()
	{
		...
		MEDICINE_ENABLE_DETAILED_SANITARY_DISPLAY = RegisterSettingBool("Medicine.DetailedSanitaryDisplay", "Medicine", "The parameter determines whether the sanitary of hands is displayed detailed or if a symbol is only displayed when the hands are sterile", true, false);
		...
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MIN = RegisterSettingFloat("Medicine.BiohazardLightSymptomIntervalMin", "Medicine", "Minimum time before light (level 1+) biohazard symptom.", 20, true);
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MAX = RegisterSettingFloat("Medicine.BiohazardLightSymptomIntervalMax", "Medicine", "Maximum time to make light (level 1+) biohazard symptom.", 40, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MIN = RegisterSettingFloat("Medicine.BiohazardHeavySymptomIntervalMin", "Medicine", "Minimum time before heavy (level 2+) biohazard symptom.", 200, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MAX = RegisterSettingFloat("Medicine.BiohazardHeavySymptomIntervalMax", "Medicine", "Maximum time to make heavy (level 2+) biohazard symptom.", 400, true);
